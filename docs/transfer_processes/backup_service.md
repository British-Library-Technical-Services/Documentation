...
The backup service is written in Python 3.x and the code is accessible [here](https://github.com/British-Library-Technical-Services/file-backup-service).

1. [Workflow](1-workflow)
2. [Requirements and Data Formatting](#2-requirements-and-data-formatting)
3. [Preprocessing Checks](#3-preprocessing-checks)
4. [Copying Files from Local a Drive](#4-copying-files-from-a-local-drive)
...
The Batch SIP spreadsheet is required and all data listed within must match against the audio and process metadata files in the directory.

The spreadsheet should be named according to the filename template:
...
| Backup Number | Batch Number | Batch SIP filename |
| :--- | :--- | :--- |
| 1 | 1 | CarloKrahmer_240307_1_ExcelBatchUpload |
| 2 | 2 | CarloKrahmer_240410_2_ExcelBatchUpload |
| 3 | 3 | CarloKrahmer_240503_3_ExcelBatchUpload |
...
## 4. Copying Files from a Local Drive
...
5. The files will be then be moved from **_staging_area** to **_backup_storage**,
